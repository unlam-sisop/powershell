...
- [PowerShell](#powershell)
  - [Guia téorica y práctica sobre PowerShell](#guia-téorica-y-práctica-sobre-powershell)
...
- [Introducción](#introducción)
  ...
  - [Shell](#shell)
  - [Lenguaje de scripting](#lenguaje-de-scripting)
  - [Administración de configuración](#administración-de-configuración)
- [](#-2)
- [Instalar PowerShell Core](#instalar-powershell-core)
  - [Windows](#windows)
  - [Linux](#linux)
    - [Instalación mediante un repositorio de paquetes, Ubuntu](#instalación-mediante-un-repositorio-de-paquetes-ubuntu)
    - [Desinstalación](#desinstalación)
  - [Mac](#mac)
    - [Instalación de la versión estable más reciente a través de Homebrew en macOS 10.13 o posterior (Recomendado)](#instalación-de-la-versión-estable-más-reciente-a-través-de-homebrew-en-macos-1013-o-posterior-recomendado)
- [](#-3)
- [IDE](#ide)
  - [Windows PowerShell ISE](#windows-powershell-ise)
    - [Para iniciar Windows PowerShell ISE](#para-iniciar-windows-powershell-ise)
  - [Visual Studio Code (Recomendado)](#visual-studio-code-recomendado)
- [CLI](#cli)
  - [cmdlets en PowerShell](#cmdlets-en-powershell)
  - [Nombres de cmdlets](#nombres-de-cmdlets)
...
- [Sintaxis de los scripts](#sintaxis-de-los-scripts)
  ...
  - [ParameterSets (Conjunto de parámetros)](#parametersets-conjunto-de-parámetros)
    - [Declarar conjuntos de parámetros](#declarar-conjuntos-de-parámetros)
  - [Parámetros desde el pipeline](#parámetros-desde-el-pipeline)
